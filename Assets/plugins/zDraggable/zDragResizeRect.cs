 ...
 public class zDragResizeRect : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, IDragHandler, IBeginDragHandler, IEndDragHandler
{
    ...
    void checkReferences()
    {
        ...
        {
            colors=colorProvider.getColors();          
        }
    ...
    {
        if (colors.useBlock) image.color = colors.hoveredColor;
    }
    void colorChanged()
    {  if (colors==null) colors=new HoverableColors();
          if (colors.useBlock)   image.color = colors.normalColor;
